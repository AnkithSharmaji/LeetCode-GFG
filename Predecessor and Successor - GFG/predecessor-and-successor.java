...
public static void findPreSuc(Node root, int key)
{
    ...
    */
    if (root == null)
        ...
        if (root.data == key) {
            // If the key node has a left subtree
            if (root.left != null) {
                Node temp = root.left;
            ...
            // If the key node has a right subtree
            if (root.right != null) {
        ...
        // If key is smaller than the root, go to the left subtree
        if (key < root.data) {
            suc = root;
            findPreSuc(root.left, key);
        }
        // If key is greater than the root, go to the right subtree
        else {
            pre = root;
